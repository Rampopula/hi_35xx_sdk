    ...
    unsigned int data ,unsigned int databytenum)
{
	unsigned int ret;
    unsigned long flags;
    // printk("hi_ssp_write: addr1=%u, addr1bytenum=%u, addr2=%u, addr2bytenum=%u, data=%u, databytenum=%u.\n",
        // addr1, addr1bytenum, addr2, addr2bytenum, data, databytenum);
    printk("hi_ssp_write: addr1=%#x, addr1bytenum=%#x, addr2=%#x, addr2bytenum=%#x, data=%#x, databytenum=%#x.\n",
        addr1, addr1bytenum, addr2, addr2bytenum, data, databytenum);
